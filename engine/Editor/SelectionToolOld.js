...
//     // ... (Metode _getTransform, _isLocked, toWorld, getAABB, getMarqueeWorld, destroy, attachTransform tetap sama) ...
//     _getTransform(e) {
...
//     // ... (Metode syncSelectionFromBus, handleUISelect, consolidateSelection, _hitTestRecursive, hit, isPointInEntity, isInsideGroup, _checkMarqueeRecursive, updateHoverMarquee tetap sama) ...
...
//     // ... (update, updateHover, pointerDown, pointerUp tetap sama) ...
//     update() {
//         if (!this.active) return;
...
//     // ... (drawObb, drawSelected, drawHover, drawMarquee, calculateViewportInsets, updateAutoPan, applyPointerAutoPan, applyMarqueeAutoPan tetap sama) ...
