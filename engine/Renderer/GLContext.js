...
export default class GLContext {
    constructor(canvas) {
        ...
        console.log("🟥 DEBUG canvas param = ", canvas);
        console.log("🟥 DEBUG typeof canvas = ", typeof canvas);
        console.log("🟥 DEBUG isElement? ", canvas instanceof HTMLElement);
        const opts = {
            alpha: false,
            antialias: true,
            depth: false,
