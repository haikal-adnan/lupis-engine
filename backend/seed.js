  ...
  try {
    ...
    await Prefab.create({
      ...
      data: {
        ...
        zIndex: 5, 
        components: {
          Transform: { x: 0, y: 0, scaleX: 2, scaleY: 2, width: 50, height: 50, flipX: false, flipY: false },
          SpriteRenderer: { assetId: assetDungeonId, sourceX: 128, sourceY: 0, sourceWidth: 32, sourceHeight: 32, color: "#FFFFFF", opacity: 1 },
          Collider: { type: "solid", width: 32, height: 32 }
        }
      }
    });
      ...
      entities: [
        {
          ...
          isActive: true,
          components: {
            Transform: { x: 0, y: 0, width: 640, height: 480, scaleX: 1, scaleY: 1, flipX: false, flipY: false },
            Tilemap: {
...

        {
            ...
            isActive: true,
            components: {
              Transform: { x: 300, y: 500, width: 800, height: 32, pivotX: 0.5, pivotY: 0.5, flipX: false, flipY: false },
              ShapeRenderer: { type: "rectangle", color: "#4CAF50", width: 800, height: 32 },
              Collider: { type: "solid", width: 800, height: 32 }
            }
        },

        {
          ...
          isActive: true,
          components: {
            Transform: { x: 300, y: 300, width: 64, height: 64, pivotX: 0.5, pivotY: 0.5, flipX: false, flipY: false },
            ShapeRenderer: { type: "rectangle", color: "#FF0000", width: 64, height: 64 },
            Collider: { type: "solid", width: 64, height: 64 },
            Physics: { enabled: true, type: "dynamic", mass: 1, gravityScale: 2 },
            ScriptController: {
              data: [
