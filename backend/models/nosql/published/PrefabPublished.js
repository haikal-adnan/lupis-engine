...
const PrefabPublishedSchema = new mongoose.Schema({
...
export default mongoose.models.PrefabPublished || mongoose.model('PrefabPublished', PrefabPublishedSchema, 'prefabsPublished');