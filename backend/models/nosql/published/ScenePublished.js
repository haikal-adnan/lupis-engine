...
const ScenePublishedSchema = new mongoose.Schema({
  _id: { type: String, required: true },
...
export default mongoose.models.ScenePublished || mongoose.model('ScenePublished', ScenePublishedSchema, 'scenesPublished');