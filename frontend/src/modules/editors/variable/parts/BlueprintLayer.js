...
export const BlueprintLayer = {
  ...
  items: [
    { 
      ...
      description: 'Get layer info like ID, Name, Visible, Locked, Z-Index', 
      icon: Scan, 
      ...
      defaultData: { 
        ...
        inputs: [{ _id: 'target', label: 'Layer ID (Self)', dataType: 'string', color: '#E040FB' }], 
        outputs: [] 
      } 
    },
    { 
      ...
      description: 'Set layer info like Name, Visible, Locked, Z-Index', 
      icon: Settings2,
      ...
      defaultData: { 
        ...
        inputs: [
          ...
          { _id: 'target', label: 'Layer ID (Self)', dataType: 'string', color: '#E040FB' }
        ], 
