...
<template>
  <div class="min-h-screen bg-background text-foreground font-sans flex flex-col selection:bg-indigo-500/30">
    ...
    <header class="h-16 border-b border-border sticky top-0 bg-background/90 backdrop-blur-md z-50 px-4 lg:px-6">
      <div class="max-w-[1400px] mx-auto w-full h-full flex items-center justify-between">
        
        <div class="flex items-center gap-2.5 cursor-pointer w-64 shrink-0">
          ...
          <span class="text-xs bg-muted text-muted-foreground px-1.5 py-0.5 rounded-md border border-border ml-2">v2.4.0</span>
        </div>

        <div class="flex-1 max-w-xl hidden md:block px-6" >
          <div class="relative group flex items-center w-full transition-all duration-200 border rounded-md bg-muted/30 focus-within:border-indigo-500 focus-within:ring-1 focus-within:ring-indigo-500 border-border h-9">
            ...
            <input 
              ...
              class="w-full h-full bg-transparent border-none outline-none text-sm text-foreground placeholder:text-muted-foreground focus:ring-0 px-2"
            />
            <div class="flex items-center pr-2">
              <kbd class="hidden sm:inline-flex h-5 items-center gap-1 rounded border border-border bg-muted px-1.5 font-mono text-[10px] font-medium text-muted-foreground">
        ...
        <nav class="flex items-center gap-6 text-sm font-medium text-muted-foreground">
          <a href="#" class="hover:text-foreground transition-colors hidden sm:block">GitHub</a>
          <a href="#" class="hover:text-foreground transition-colors hidden sm:block">Discord</a>
        </nav>
    ...
    <div class="flex-1 max-w-[1400px] mx-auto w-full flex items-start px-4 lg:px-6">
      ...
      <aside class="hidden lg:block w-64 shrink-0 h-[calc(100vh-4rem)] sticky top-16 overflow-y-auto py-8 pr-6 border-r border-border custom-scrollbar">
        <nav class="space-y-6">
          <div v-for="(section, index) in sidebarNav" :key="index">
            ...
            <ul v-if="section.links.length" class="space-y-1 border-l border-border/50 ml-2 pl-4">
      ...
      <aside class="hidden xl:block w-56 shrink-0 h-[calc(100vh-4rem)] sticky top-16 py-8 pl-4">
        ...
        <nav class="border-l border-border/50">
          <ul class="space-y-2">
